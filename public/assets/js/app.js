! function () {
   ...
   function u() {
      var t, e, a;
      eva.replace(), 
      window.sessionStorage && ((t = sessionStorage.getItem("is_visited")) ? null !== (e = document.querySelector("#" + t)) && (e.checked = !0, a = t, 1 == document.getElementById("layout-direction-ltr").checked && "layout-direction-ltr" === a ? (document.getElementsByTagName("html")[0].removeAttribute("dir"), 
      	...
      	document.getElementById("bootstrap-style").setAttribute("href", '#####'), 
      	document.getElementById("app-style").setAttribute("href", "#######"), 
      ...
      s.hasAttribute("data-layout") && "horizontal" == s.getAttribute("data-layout") ? (m("layout-horizontal"), 
      	...
      	"light" == s.hasAttribute("data-topbar") ? (m("topbar-color-light"), 
      		...
      		m("layout-vertical"), document.getElementsByClassName("topnav")[0].style.display = "none", 
      ...
      function () {
         ...
         t.addEventListener("change", function (t) {
            t && t.target && t.target.value && ("ltr" == t.target.value ? (document.getElementsByTagName("html")[0].removeAttribute("dir"), 
            	document.getElementById("bootstrap-style").setAttribute("href", baseUrl + "assets/css/bootstrap.min.css"), 
            	document.getElementById("app-style").setAttribute("href", baseUrl + "assets/css/app.min.css"), 
            	sessionStorage.setItem("is_visited", "layout-direction-ltr")) : (document.getElementById("bootstrap-style").setAttribute("href", baseUrl + "assets/css/bootstrap-rtl.min.css"), 
            	document.getElementById("app-style").setAttribute("href", baseUrl + "assets/css/app-rtl.min.css"), document.getElementsByTagName("html")[0].setAttribute("dir", "rtl"), 
