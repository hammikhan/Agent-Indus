        ...
        <div class="page-content">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <h5 class="card-title">User List <span class="text-muted fw-normal ms-2">({{ count($admin_users)}})</span></h5>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
                            ...
                            @if(auth('admin')->user()->can('Add-Users'))
                                <div>
                                                ...
                                                <ul class="list-inline mb-0">
                                                    @if(auth('admin')->user()->can('Edit-Users'))
                                                        <li class="list-inline-item">
                                                            <a href="{{ url('admin/view-user',$user->id)}}" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" class="px-2 text-primary">
                                                    ...
                                                    @if(auth('admin')->user()->can('Delete-Users'))
                                                        <li class="list-inline-item">
                                                            <a href="{{ url('admin/delete-user',$user->id)}}" onclick="return confirm('Are you sure you want to delete agent')" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete" class="px-2 text-danger">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="first_name" placeholder="Enter First Name" id="AddNew-first_name" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label" for="AddNew-last_name">Last Name</label>
                                            <input type="text" class="form-control" name="last_name" placeholder="Enter Last Name" id="AddNew-last_name" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="email" class="form-control" name="email" placeholder="Enter Email" id="AddNew-Email" autocomplete="off" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
